...
<body>
	...
	<form action="/school/BHCorrection/Member/BhMemberUpdateConfirm" method="post">
		<c:forEach var="bh" items="${bhList }">
			...
			<table class="table table-striped my-5">
				...
				<tr>
					<th>제목</th>
					<td><input type="text" name="title" required="required" maxlength="30"
						value="${bh.title }"></td>
				</tr>
				<tr>
					<th>성함</th>
				...
				<tr>
					<th>상세 내용</th>
					<td><input type="text" name="beforeContent"
						required="required" maxlength="330" value="${bh.beforeContent }"></td>
				</tr>
			</table>
		</c:forEach>
