...
public class CusNoticeRepositoryImpl implements CusNoticeRepository {
	...
	public PageResponseDTO<CusNotice> findAll(PageRequestDTO pageRequestDTO) {
		...
		if(sorting.equals("desc")) {
		 list =
				em.createQuery("select n from CusNotice as n ORDER BY Regdate desc", CusNotice.class)
		...
		if(sorting.equals("asc")) {
			 list =
						em.createQuery("select n from CusNotice as n ORDER BY Regdate", CusNotice.class)
							.setFirstResult(offset)
							.setMaxResults(maxResult)
							.getResultList();
		}
	...
	public PageResponseDTO<CusNotice> findBytitleOrderByRegdate(PageRequestDTO pageRequestDTO) {
		...
		String titlek ='%' + title +'%';
		List<CusNotice> list =
			em.createQuery("select n from CusNotice AS n WHERE n.title like :title ORDER BY Regdate "+sort, CusNotice.class)
		...
		PageResponseDTO<CusNotice> dto = new PageResponseDTO<CusNotice>(byTitleCount(pageRequestDTO), pageRequestDTO, list);
		return dto;
	}
	...
	public Long byTitleCount(PageRequestDTO pageRequestDTO) {
		...
		String titlek ='%' + title +'%';
		Long count =
			em.createQuery("select count(n) from CusNotice AS n WHERE n.title like :title ORDER BY Regdate "+sort, Long.class)
				.setParameter("title", titlek)
				.getSingleResult();
	...
	public PageResponseDTO<CusNotice> findByContentOrderByRegdate(PageRequestDTO pageRequestDTO) {
		...
		List<CusNotice> list =
			em.createQuery("select n from CusNotice AS n WHERE n.content like :content ORDER BY Regdate "+sort, CusNotice.class)
				.setParameter("content", contentk)
				.setFirstResult(offset)
				.setMaxResults(maxResult)
				.getResultList();
		PageResponseDTO<CusNotice> dto = new PageResponseDTO<CusNotice>(byContentCount(pageRequestDTO), pageRequestDTO, list);
		return dto;
	}
	...
	public Long byContentCount(PageRequestDTO pageRequestDTO) {
		...
		Long total =
			em.createQuery("select count(n) from CusNotice AS n WHERE n.content like :content ORDER BY Regdate "+sort, Long.class)
				.setParameter("content", contentk)
				.getSingleResult();
		return total;
	}
	...
	public PageResponseDTO<CusNotice> findByAllOrderByRegdate(PageRequestDTO pageRequestDTO) {
		...
		List<CusNotice> list =
			em.createQuery("select n from CusNotice AS n WHERE (n.title like :keyword OR n.content like :keyword) ORDER BY Regdate "+sort, CusNotice.class)
				.setParameter("keyword", titleContentk)
				.setFirstResult(offset)
				.setMaxResults(maxResult)
				.getResultList();
		
		PageResponseDTO<CusNotice> dto = new PageResponseDTO<CusNotice>(byAllCount(pageRequestDTO), pageRequestDTO, list);
	...
	public Long byAllCount(PageRequestDTO pageRequestDTO) {
		...
		Long total =
			em.createQuery("select count(n) from CusNotice AS n WHERE (n.title like :keyword OR n.content like :keyword) ORDER BY Regdate "+sort, Long.class)
				.setParameter("keyword", titleContentk)
				.getSingleResult();
		return total;
	}
