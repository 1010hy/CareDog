...
//--------------------------------------유치원-------------------------------------------------------------------------------------
	...
	//유치원 알림장
	/*
	 * @GetMapping("/school/dogNotice/main") public String schoolDogNotice() {
	...
	// 행동교정신청
	/*
	 * @GetMapping("/school/BHCorrection/main") public String
	 * schoolBHCorrectionMain() { return "school/BHCorrection/main"; }
	 */
//--------------------------------------고객서비스------------------------------------------------------------------------------------
