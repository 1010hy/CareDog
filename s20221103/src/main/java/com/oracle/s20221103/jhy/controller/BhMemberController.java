...
//		System.out.println("BHMain currentPage" + currentPage);
	...
	public String BhConfirm(BHCorrectionDTO bhDto, Model model, @AuthenticationPrincipal PrincipalDetails principal) {
		MemberDTO myInfo = principal.getUser();
		bhDto.setMemberId(myInfo.getId());
	...
	public String BhSelect(BHCorrectionDTO bhDto, Model model, @AuthenticationPrincipal PrincipalDetails principal) {
		MemberDTO myInfo = principal.getUser();
		bhDto.setMemberId(myInfo.getId());
	...
	@RequestMapping(value="/school/BHCorrection/Member/BhMemberDelete")
	 public String BhMemberDelete(int appliNo, Model model) {
		model.addAttribute("appliNo", appliNo);
		System.out.println("BhMemberDelete appliNo ->" + appliNo);
		return "school/BHCorrection/Member/BhMemberDelete";
	 }
